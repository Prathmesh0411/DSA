...
that flight take to reach city B from A, or the amount of fuel used for the journey.
...
matrix representation of the graph. Check whether the graph is connected or
